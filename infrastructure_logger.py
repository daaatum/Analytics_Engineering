import os
import logging
from config import log_folder, infrstr_log_file
...
def log(msg):
    ...
    logger = logging.getLogger(infrstr_log_file)
    ...
    if not logger.handlers:
        ...
        handler = logging.FileHandler(os.path.join(logfolder, infrstr_log_file), encoding='utf-8')
